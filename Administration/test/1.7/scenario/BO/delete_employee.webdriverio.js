...
describe('Test case n°2 = Delete customer ', function(){
    ...
    describe('Delete customer in Back Office', function (done) {
        ...
        it('should search the customer by email', function (done) {
            this.client
        ...
        it('should select the customer id', function (done) {
            this.client
                .pause(1000)
        ...
        it('should select the action to delete customer', function (done) {
            this.client
                .pause(1000)
